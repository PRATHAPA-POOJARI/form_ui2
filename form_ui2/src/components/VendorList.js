...
import VendorViewForm from './VendorViewForm'; // Import the VendorViewForm component
...
const VendorListItem = ({ vendor, onDelete, onView, onEdit }) => (
  <Paper key={vendor._id} style={{ padding: 10, maxWidth: 400, margin: 'auto', marginTop: 10, border: '1px solid #ccc', borderRadius: 8 }}>
    ...
    {/* Use VendorViewForm when "View Vendor" is clicked */}
    ...
    {/* Render the VendorViewForm for the selected vendor */}
